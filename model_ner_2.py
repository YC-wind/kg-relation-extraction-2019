...
def train():
    ...
    with tf.Session(config=config) as sess:
        ...
        ckpt = tf.train.get_checkpoint_state('./ckpt_2/')
        if ckpt:
...
class Model:
    def __init__(self):
        ...
        with open('./ckpt_2/ner.pb', "rb") as f:
...
if __name__ == "__main__":
    ...
    m = Model()
    spo_list = m.predict("作品赏析胡新良作品集胡新良作品中共邵阳县委党校胡新良，男，汉族，1968年7月生，湖南邵阳人")
    # print(spo_list)
    # m.submit()
