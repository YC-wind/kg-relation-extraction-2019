...
t = Bidirectional(LSTM(int(char_size / 2), return_sequences=True))(t)  # CuDNNLSTM
t = Bidirectional(LSTM(int(char_size / 2), return_sequences=True))(t)
...
train_model.fit_generator(train_D.__iter__(),
                          steps_per_epoch=len(train_D) / 32,
                          epochs=10,
                          callbacks=[evaluator],
                          verbose=2
                          )
